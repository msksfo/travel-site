...
var MobileMenu = function () {
	function MobileMenu() {
		...
		//this function will be run immediately when a new object is created with this class.
  ...
  */
		...
		this.menuIcon = (0, _jquery2.default)('.site-header__menu-icon'); // store the dom selection for the menu icon element.
	...
	_createClass(MobileMenu, [{
		...
		value: function events() {
			// list all events that we want to watch for
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // in order to use jQuery in this module, we need to import it first.
// this will automatically work as long as jquery is in node modules folder
...
var RevealOnScroll = function () {
	function RevealOnScroll(els, offset) {
		...
		// 2 parameters: element(s) and offset
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({ // each Waypoint object needs at least these 2 properties
					...
					handler: function handler() {
						// what we want to happen when the element is scrolled to --> add the css modifyer so that it gradually becomes visible
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.headerLinks = (0, _jquery2.default)(".primary-nav a"); // this property is a collection of header link elements
